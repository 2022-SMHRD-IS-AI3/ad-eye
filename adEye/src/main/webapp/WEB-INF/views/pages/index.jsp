      		...
      		<main>
                 <header class="pt-10 mb-4 bg-light">
                        <div class="container-xl px-4">
                        	<img alt="" src="./img/main-img02.jpg" class="col-13"> 
                    ...
                    <div class="container-xl px-4">
                        	...
                        	<p><에드아이>는 단순히 유동인구로 광고효과를 파악하지 않습니다.</p>
                        	<p>유동인구 뿐만 아니라 성별과 주요 시청 횟수를</p> 
                        	<p>수치화하여 더욱 정확한 광고 효과를 측정합니다.</p>
        
                        	<img alt="" src="./img/main-img.jpg" >
