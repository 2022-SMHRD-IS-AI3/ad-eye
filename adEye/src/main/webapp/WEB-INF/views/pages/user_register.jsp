...
<link rel="icon" type="image/x-icon"
	href="${path}/resources/assets/img/logo.png" />
...
<body class="nav-fixed">
	<nav
		...
		<a class="navbar-brand pe-3 ps-4 ps-lg-2" href="#"> <svg
		...
		<ul class="navbar-nav align-items-center ms-auto">
			...
			<li class="nav-item dropdown no-caret dropdown-user me-3 me-lg-4">
				...
				aria-expanded="false"><img class="img-fluid"
					src="${path}/resources/assets/img/user-gear.png" /></a>
				<div
					class="dropdown-menu dropdown-menu-end border-0 shadow animated--fade-in-up"
					aria-labelledby="navbarDropdownUserImage">
					<h6 class="dropdown-header d-flex align-items-center">
						<img class="dropdown-user-img"
							src="${path}/resources/assets/img/user-gear.png" />
				...
				<div class="sidenav-menu">
					<div class="nav accordion" id="accordionSidenav">
						...
						<a class="nav-link collapsed" href="javascript:void(0);"
							...
							aria-expanded="false" aria-controls="collapseDashboards"> 기기
							관리
						...
						<div class="collapse" id="collapseDashboards"
							...
							<nav class="sidenav-menu-nested nav accordion"
								...
								<a class="nav-link" href="#!">기기 목록</a> <a class="nav-link"
									href="#!">기기 등록</a>
							</nav>
						</div>
						...
						<div class="collapse" id="pagesCollapseAccount"
							...
							<nav class="sidenav-menu-nested nav accordion"
								id="accordionSidenavPages">
								<a class="nav-link" href="/pages/user_management">회원 목록</a> <a
									class="nav-link" href="/pages/user_register">회원 등록</a>
							</nav>
						</div>
						...
						<a class="nav-link collapsed" href="javascript:void(0);"
							...
							aria-controls="pagesCollapseAuthBasic"> 구독 관리
							<div class="sidenav-collapse-arrow">
								<i class="fas fa-angle-down"></i>
							</div>
						</a>
						<div class="collapse" id="pagesCollapseAuthBasic"
							...
							<nav class="sidenav-menu-nested nav accordion"
								id="accordionSidenavPages">
								<a class="nav-link" href="/pages/subscription">구독 목록</a> <a
									class="nav-link" href="/pages/subscription_register">구독 등록</a>
							</nav>
						</div>
						<!-- Sidenav Link (로그)-->
						<a class="nav-link" href="#!"> 로그 관리 <!-- Sidenav Link (문의)-->
