...
<c:set var="contextPath" value="${pageContext.request.contextPath == '/' ? '' : pageContext.request.contextPath }" scope="application" />
            ...
            <div class="row">
                            ...
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                	<c:forEach items="${list }" var="board">
                                		<tr>
                                			<td>${board.bno }</td>
                                			<td><a href="${contextPath}/board/read?bno=${board.bno}&pageNum=${cri.pageNum}&amount=${cri.amount}&type=${cri.type}&keyword=${cri.keyword}">${board.title}</a></td>
                                			<td>${board.writer}</td>
                ...
                <div class="row">
                	<div class="col-lg-12">
                		<form action="${contextPath}/board/list" id="searchForm" method="get">
               				<select name="type">
